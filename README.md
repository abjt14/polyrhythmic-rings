...
This web application is built using [Next.js](https://nextjs.org/), [SVGs](https://developer.mozilla.org/en-US/docs/Web/SVG), [Framer Motion](https://www.framer.com/motion/), and [Radix UI](https://www.radix-ui.com/).
